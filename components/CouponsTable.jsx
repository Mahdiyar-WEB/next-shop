...
import { useGetCoupons, useRemoveCoupon } from "@/hooks/useGetCoupons";
...
const CouponsTable = ({ title, displayCount = null, rowsPerPage = 5 }) => {
  const { data: information } = useGetCoupons();
  const queryClient = useQueryClient();
  const { isPending, mutateAsync } = useRemoveCoupon();
