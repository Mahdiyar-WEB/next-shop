...
import { adminOrdersTableHead } from "@/constants/tableHeads";
...
const AdminOrdersTable = ({
  ...
  const { data: information } = useGetPayments();
                ...
                (
                  ...
                  return (
                    ...
                    >
                      ...
                      <td>
                        <div className="flex flex-wrap w-80 gap-1 text-xs">
                          <Badge icon={<FaUser />} title={user.name} />
                          <Badge icon={<MdEmail />} title={user.email} />
                          <Badge icon={<FaPhoneAlt />} title={user.phoneNumber} />
                        </div>
                      </td>
